...
namespace NETUploadClient.SyncSocketCore
{
    public class IncomingDataParser
    {
        ...
        public bool DecodeProtocolBuffer(byte[] buffer, int offset, int commandLen)
        {
            //
            ...
            if (BitConverter.ToInt16(Buffer, 2) == (short)XYSocketCommand.Notify)
            {
                Notify lg = new Notify();
                lg.Buffer = Buffer;
                lg.Buffer2Property();
                if (lg.matter == 0 && lg.lparam[0] == 1 && lg.lparam[1] == 0) return false;
                return true;
            }
          else  if (BitConverter.ToInt16(Buffer, 2) == (short)XYSocketCommand.Log )
            {
                Log lg = new Log();
                lg.Buffer = Buffer;
                lg.Buffer2Property();
            ...
            else if (Buffer[BitConverter.ToInt16(Buffer, 2)] == (byte)XYSocketCommand.Add)
            {
                Add lg = new Add();
                lg.Buffer = Buffer;
                lg.Buffer2Property();
                ...
                //{
                //    CommandEvent(new MyEventArgs(lg, ""));
                //}
                return true;
            }
            else if (Buffer[BitConverter.ToInt16(Buffer, 2)] == (byte)XYSocketCommand.Replace )
            {
                Replace lg = new Replace ();
                lg.Buffer = Buffer;
                lg.Buffer2Property();
                //if (CommandEvent != null)
                //{
            ...
            else if (Buffer[BitConverter.ToInt16(Buffer, 2)] == (byte)XYSocketCommand.Delete )
            {
                Delete lg = new Delete();
                lg.Buffer = Buffer;
                lg.Buffer2Property();
                //if (CommandEvent != null)
                //{
        ...
        public bool DecodeProtocolBuffer(byte[] buffer, int offset, int commandLen,out ProtocolBase command )
        {
            byte[] Buffer = new byte[commandLen];
            for (var i = 0; i < Buffer.Length; i++)
            {
            ...
            else if (BitConverter.ToInt16(Buffer, 2) == (byte)XYSocketCommand.Add)
            {
                Add lg = new Add();
                lg.Buffer = Buffer;
                lg.Buffer2Property();
            ...
            else if (BitConverter.ToInt16(Buffer, 2) == (byte)XYSocketCommand.Replace)
            {
                Replace lg = new Replace();
                lg.Buffer = Buffer;
                lg.Buffer2Property();
            ...
            else if (BitConverter.ToInt16(Buffer, 2) == (byte)XYSocketCommand.Delete)
            {
                Delete lg = new Delete();
                lg.Buffer = Buffer;
                lg.Buffer2Property();
        ...
        internal bool DecodeProtocolBuffer(object tmpStr)
        {
